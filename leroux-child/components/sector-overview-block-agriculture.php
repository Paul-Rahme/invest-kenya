...
/*
|--------------------------------------------------------------------------
| Shortcode: [sector_overview_agriculture]
| Updated to match manufacturing layout + right contact card
|--------------------------------------------------------------------------
*/

function shortcode_agriculture_overview() {
...
<!-- ===========================
     AGRICULTURE — NEW LAYOUT
     Matching Manufacturing Layout
=========================== -->
    ...
    <div class="ike-two-columns">
        ...
        <div class="ike-left">
            ...
            <div class="ike-snapshot-row">
                ...
                <!-- SNAPSHOT 4 (SPECIAL FORMATTING) -->
                <div class="ike-snap">
                    <div class="ike-snap-label-top"><?php echo esc_html($s4_label_1); ?></div>
                    <div class="ike-snap-number"><?php echo esc_html($s4_num); ?>%</div>
                    <div class="ike-snap-label"><?php echo esc_html($s4_label_2); ?></div>
                </div>
...
@media (max-width:1260px) and (min-width:768px){
    ...
    /* White column side margins */
    .ike-right{
        box-sizing: border-box;
    }

    /* Reset any flex/grid side effects */
    .ike-contact-card{
        display: block;
    }

    /* Person row: icon + name */
    .ike-contact-person{
        display: flex;
        align-items: center;
        gap: 10px;
    ...
    /* Button under person, NOT stretched */
    .ike-red-button{
        width: auto;
        display: inline-flex;
        padding: 0 22px;
...
add_shortcode('sector_overview_agriculture', 'shortcode_agriculture_overview');
